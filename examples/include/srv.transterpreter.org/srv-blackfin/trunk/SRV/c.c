...
char *find_func(char *);
void call();
void print(), motors(), delay(), imgcap(), imgdiff(), imgrcap(), laser();
void color(), writei2c(), servo(), servo2();
int time(), blob(), input(), readi2c(), readi2c2(), sonar(), crand(), crange();
void resolution();
...
struct intern_func_type {
    ...
    {"color", (int(*)())color},
    {"readi2c", (int(*)())readi2c},
    {"readi2c2", (int(*)())readi2c2},
    {"writei2c", (int(*)())writei2c},
    {"sonar", (int(*)())sonar},
    {"servo", (int(*)())servo},
    {"servo2", (int(*)())servo2},
...
int errjmp[41];  //  buffer for setjmp() / longjmp()
int c(char *pc)
{
    p_buf = pc;
...
void sntx_err(int error)
{
    ...
    for(i=0; i<30 && p<=temp; i++, p++) putchar(*p);
    errjmp[40] = 1;
    longjmp(errjmp, 1);
}
...
void laser()    // laser(1) turns them on, laser(0) turns them off
{
    int ix;
